...
open class PriceChartView: UIView {
    @IBInspectable var background: UIColor = UIColor.color("0x313131")
    @IBInspectable var downColor: UIColor = UIColor.color("0xff4953")
    @IBInspectable var upColor: UIColor = UIColor.color("0x00d5ff")
    ...
    @IBInspectable var textColor: UIColor = UIColor.color("0xC4C4C4")
    ...
    private func drawCandlestick(x: CGFloat, close: Double, open: Double, high: Double, low: Double) {
        ...
        layer.contentsScale = UIScreen.main.scale
        lineLayer.cornerRadius = 4
        lineLayer.maskedCorners = [.layerMinXMinYCorner, .layerMaxXMinYCorner]
